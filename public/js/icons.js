...
const PATHS = {
  ...
  "tipos-equipo": '<path d="M15.4 5.4a4.5 4.5 0 0 0-5.9 5.9l-5 5a1.6 1.6 0 0 0 2.3 2.3l5-5a4.5 4.5 0 0 0 5.9-5.9l-2.5 2.5-2.1-.4-.4-2.1 2.7-2.8Z"/>',
  "tipos-producto": '<path d="M12 3 3 8l9 5 9-5-9-5Z"/><path d="m3 13 9 5 9-5"/>',
